...
export default function Experience() {
  return (
    <div className="bg-[#21325e] text-white flex justify-center items-center flex-col overflow-auto h-screen ">
      <div className="mt-80">
        <h2 className='text-4xl text-center font-bold underline decoration-pink-600 decoration-4 underline-offset-4'>Past Experiences</h2>
        <div >
          <div className="mb-3 ">
            <h2 className="font-bold mb-2 mt-4 text-center text-2xl">Business Analyst, Cognizant, DesMoines, IOWA (2012-2013)</h2>
            <ul className="list-disc list-inside p-3 ml-32">
          ...
          <div className="mb-3">
            <h2 className="font-bold mb-2 text-center text-2xl">System analyst , Cognizant, Chennai India (2009-2013)</h2>
            <ul className="list-disc list-inside p-3 ml-32">
          ...
          <div className="mb-3">
            <h2 className="font-bold mb-2 text-center text-2xl"> Module Lead, HCL, Chennai India (2007-2009)</h2>
            <ul className="list-disc list-inside p-3 ml-32">
