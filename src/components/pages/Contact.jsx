...
export default function Contact() {
  ...
  return (
    <div className='w-full h-screen bg-[#21325e] flex justify-center  overflow-auto items-center p-4'>
      <form method='POST' action="https://getform.io/f/41d50945-9729-49af-bb28-20949af851d6" className='flex flex-col max-w-[600px] w-full mt-32 sm:mt-36' onSubmit={handleFormSubmit}>
        <div>
