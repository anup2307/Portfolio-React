export default function Resume() {
  return (
    <div className=' h-screen bg-[#21325e]  p-16'>
      <h1 className=' p-0 mb-8 text-2xl'>Download <a href='../../assets/Anu Priya govindarajan.docx' target="_blank" className="border-b-4 border-pink-600 font-bold">My Resume</a></h1>
      ...
      <div className='w-full flex flex-row mt-3'>
        ...
        <div>
          <p className=" text-white p-2 font-bold"> ReactJS, HTML, CSS, BootStrap, TailwindCSS, Handlebars</p>
        </div>
      </div>
      <div className='w-full flex flex-row mt-3'>
