export default function Resume() {
  return (
    <div className="h-screen bg-[#21325e] flex flex-col justify-center items-center">
      <div>
        <h1 className=' p-0 mb-8 text-2xl'>Download <a href='../../assets/AnuPriyaGovindarajan.docx' target="_blank" className="border-b-4 border-pink-600 font-bold">My Resume</a></h1>
